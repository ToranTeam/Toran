...
The key and certificate is in a separate, passTNXase-protected keychain file that is
...
The key and certificate were exported into a separate, passTNXase-protected PKCS#12 file, and
...
install a keylogger to get the passTNXase that protects them.

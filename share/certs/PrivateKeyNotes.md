...
The key and certificate is in a separate, passSLTCase-protected keychain file that is
...
The key and certificate were exported into a separate, passSLTCase-protected PKCS#12 file, and
...
install a keylogger to get the passSLTCase that protects them.

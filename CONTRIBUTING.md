Contributing to TNX Core
============================

The TNX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TNX Core project, and is not to be
confused with overall TNX Network Protocol consensus changes.

Whether a pull request is merged into TNX Core rests with the project merge
...
The project leader is the release manager for each TNX Core release.

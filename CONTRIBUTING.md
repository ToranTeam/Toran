Contributing to SLTC Core
============================

The SLTC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SLTC Core project, and is not to be
confused with overall SLTC Network Protocol consensus changes.

Whether a pull request is merged into SLTC Core rests with the project merge
...
Patches that change SLTC consensus rules are considerably more involved than
...
Where a patch set proposes to change the SLTC consensus, it must have been
...
The project leader is the release manager for each SLTC Core release.

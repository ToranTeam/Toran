...
This issue tracker is only for technical issues related to SLTC Core.
General SLTC questions and/or support requests and are best directed to the [SLTC Discord](https://discord.gg/sbgdcdv).
...
### What version of SLTC Core are you using?

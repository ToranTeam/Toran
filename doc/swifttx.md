...
* WebSocket: [https://github.com/TNXproject/insight-api-TNX#web-socket-api](https://github.com/TNXproject/insight-api-TNX#web-socket-api) 
* API: [https://github.com/TNXproject/insight-api-TNX#swifttx-transactions](https://github.com/TNXproject/insight-api-TNX#swifttx-transactions) 
...
By default, the TNX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TNX Core daemon:

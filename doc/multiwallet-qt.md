...
In order to support loading of multiple wallets in TNX-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is TNX.cpp.
...
Changes to TNX.cpp
----------------------
TNX.cpp is the entry point into TNX-qt, and as such, will require some minor modifications to provide hooks for

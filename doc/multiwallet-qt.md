...
In order to support loading of multiple wallets in SLTC-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is SLTC.cpp.
...
Changes to SLTC.cpp
----------------------
SLTC.cpp is the entry point into SLTC-qt, and as such, will require some minor modifications to provide hooks for

...
#   c) node1 mines 32 blocks, so now node 0 has 60001SLTC, node 1 has 4250SLTC, node2 has none.
#   d) node0 sends 601 SLTC to node2, in two transactions (301 SLTC, then 300 SLTC).

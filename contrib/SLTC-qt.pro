...
FORMS += src/qt/forms/addressbookpage.ui \
         src/qt/forms/askpassSLTCasedialog.ui \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/qt/askpassSLTCasedialog.cpp \
...
RESOURCES += src/qt/SLTC.qrc src/qt/SLTC_locale.qrc

TRANSLATIONS += src/qt/locale/SLTC_bg.ts \
                src/qt/locale/SLTC_de.ts \
                src/qt/locale/SLTC_en.ts \
                src/qt/locale/SLTC_es.ts \
                src/qt/locale/SLTC_fi.ts \
                src/qt/locale/SLTC_fr.ts \
                src/qt/locale/SLTC_it.ts \
                src/qt/locale/SLTC_ja.ts \
                src/qt/locale/SLTC_pl.ts \
                src/qt/locale/SLTC_pt.ts \
                src/qt/locale/SLTC_ru.ts \
                src/qt/locale/SLTC_sk.ts \
                src/qt/locale/SLTC_sv.ts \
                src/qt/locale/SLTC_vi.ts \
                src/qt/locale/SLTC_zh_CN.ts \
                src/qt/locale/SLTC_zh_TW.ts

...
const int64_t AUTOMINT_DELAY = (60 * 60 * 60 * 60 * 60 * 60 * 5); // Wait at least 5 minutes until Automint starts

int nAnonymizeTNXAmount = 0;
int nLiquidityProvider = 0;
/** Spork enforcement enabled time */
int64_t enforceMasternodePaymentsTime = 10;

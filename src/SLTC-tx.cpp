...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SLTC Core SLTC-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  SLTC-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SLTC transaction") + "\n" +
                               "  SLTC-tx [options] -create [commands]   " + _("Create hex-encoded SLTC transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded SLTC transaction
